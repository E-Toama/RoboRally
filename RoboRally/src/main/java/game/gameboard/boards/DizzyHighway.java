...
public class DizzyHighway {
    ...
    public final BoardElement[][] _5B = {
            ...
            {       new BoardElement(16, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                    new BoardElement(17, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, true, new String[]{"down", "left"})}),
                    new BoardElement(18, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, true, new String[]{"left", "right"})}),
                    ...
                    new BoardElement(24, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, true, new String[]{"left", "left"})}),
            ...
            {       new BoardElement(29, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                    ...
                    new BoardElement(37, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, true, new String[]{"up", "right"})}),
            ...
            {       new BoardElement(42, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                    ...
                    new BoardElement(45, new GameBoardFieldObject[]{new WallFieldObject(new String[]{"up"}), new LaserFieldObject("down", 1)}),
                    ...
                    new BoardElement(48, new GameBoardFieldObject[]{new WallFieldObject(new String[]{"right"}), new LaserFieldObject("left", 1)}),
            ...
            {       new BoardElement(81, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                    ...
                    new BoardElement(84, new GameBoardFieldObject[]{new WallFieldObject(new String[]{"left"}), new LaserFieldObject("right", 1)}),
                    ...
                    new BoardElement(87, new GameBoardFieldObject[]{new WallFieldObject(new String[]{"down"}), new LaserFieldObject("up", 1)}),
            ...
            {       new BoardElement(94, new GameBoardFieldObject[]{new BeltFieldObject("right", 2)}),
                    new BoardElement(95, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, true, new String[]{"down", "right"})}),
            ...
            {       new BoardElement(107, new GameBoardFieldObject[]{new BeltFieldObject("right", 2)}),
                    new BoardElement(108, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, true, new String[]{"right", "left"})}),
                    ...
                    new BoardElement(114, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, true, new String[]{"right", "right"})}),
                    new BoardElement(115, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, true, new String[]{"up", "left"})}),
