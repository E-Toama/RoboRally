...
public class ExtraCrispy {
        ...
        public static final BoardElement[][] _5B = {
                ...
                {       new BoardElement(16, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                        ...
                        new BoardElement(19, new GameBoardFieldObject[]{new RotatingBeltFieldObject(1, false, new String[]{"left", "left"})}),
                ...
                {       new BoardElement(29, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                        ...
                        new BoardElement(31, new GameBoardFieldObject[]{new ControlPointFieldObject(4), new LaserFieldObject("down", 1)}),
                        ...
                        new BoardElement(36, new GameBoardFieldObject[]{new ControlPointFieldObject(1), new LaserFieldObject("down", 1)}),
                ...
                {       new BoardElement(42, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                        new BoardElement(43, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, false, new String[]{"left", "right" })}),
                        ...
                        new BoardElement(50, new GameBoardFieldObject[]{new RotatingBeltFieldObject(2, false, new String[]{"down","right"})}),
                ...
                {       new BoardElement(94, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                        ...
                        new BoardElement(96, new GameBoardFieldObject[]{new ControlPointFieldObject(2), new LaserFieldObject("up",1)}),
                        ...
                        new BoardElement(101, new GameBoardFieldObject[]{new ControlPointFieldObject(3)}),
                ...
                {       new BoardElement(107, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                        ...
                        new BoardElement(113, new GameBoardFieldObject[]{new RotatingBeltFieldObject(1, false, new String[]{"right", "left"})}),
