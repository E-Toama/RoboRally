...
public class ExtraCrispy {
    ...
    public static final BoardElement[][] _5B = {
            {       new BoardElement(3, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                    ...
                    new BoardElement(10, new GameBoardFieldObject[]{new LaserFieldObject("right", 1)}),
            ...
            {       new BoardElement(42, new GameBoardFieldObject[]{new EmptyFieldObject()}),
                    ...
                    new BoardElement(44, new GameBoardFieldObject[]{new BeltFieldObject("right", 2), new LaserFieldObject("down", 1)}),
                    ...
                    new BoardElement(49, new GameBoardFieldObject[]{new BeltFieldObject("left", 2), new LaserFieldObject("up", 1)}),
            ...
            {       new BoardElement(55, new GameBoardFieldObject[]{new WallFieldObject(new String[]{"up"}), new EnergySpaceFieldObject(1)}),
                    ...
                    new BoardElement(57, new GameBoardFieldObject[]{new LaserFieldObject("down", 1)}),
